...
_C.TRAIN = CN()
_C.TRAIN.epochs=10
_C.TRAIN.m_inc_proc =  'inc_1_after_60_interval_10'
_C.TRAIN.show_results_epoch=1
_C.TRAIN.train_model_iter= 0
...
_C.MODEL.MODEL_A.rotation_lambda=1000
_C.MODEL.MODEL_A.shift_lambda_real=0

_C.MODEL.MODEL_DECODER = CN()
_C.MODEL.MODEL_DECODER.channel_list=[12, 10, 4, 3, 2]
