...
lr_H, T, lambda_s, batch_size= ['0.0', '1', '3', '32']
...
exps = {
        ...
        'DATASET.img_size':  ['128'],  #fixed
        'DATASET.num_samples_train': ['3450'],  #'3450' fixed
        'DATASET.num_samples_valtest': ['100'], #'100' fixed
        'DATASET.batch_size_train': [batch_size],  #fixed
}

general_opts= ['TRAIN.show_results_epoch', '1', #5  #fixed
